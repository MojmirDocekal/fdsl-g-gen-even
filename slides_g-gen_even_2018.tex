...
\item
  ...
  (exp. evidence Dočekal \& Dotlačil 2016)
\end{itemize}
...
\item
  \emph{i} $\approx$ Krifka's \emph{TONS of money} (PPI)
\item
  \emph{ani} $\approx$ Krifka's \emph{ANY} (strong NPI)
\end{itemize}
\end{frame}
...
`If son will become even sergeant, his mother will be
